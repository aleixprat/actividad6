...
export class CreateUpdateComponent {
  ...
  //Sirve para mostrar o no el form
  ...
  /** Función para pintar los datos cuando se viene a editar el usuario ********************/
  ...
  /***************** Fin Función para pintar los datos cuando se viene a editar el usuario **/
